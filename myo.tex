...
Rabbit antibodies to mouse antigens and goat antibodies to rabbit antigens conjugated with HRP (Sigma, USA, Missouri) were used as second antibodies.
...
\subsection*{Figure 6}
Gel chromatographic separation of cytoplasmic extracts from MSCWJ-1 cells at different stages of replicative senescence.
Cells were grown in 10 dishes 10 cm in diameter and lysed at passages  9, 15, 28.
Cell lysis was performed using Triton X-100 containing buffer with protease ingibitor coctaile.
...
Electrophoretic separation was carried out in 12\% acrilamide gels, then proteins were transferred to PVDF membranes and stained with polyclonal antibodies against synthetic peptide corresponding to amino acids 1949-1960 of human nonmuscle myosin IIA and monoclocal anti-$\beta$-actin antibodies.
Fraction number indicated obove each membrane.
Passage number indicated on the right from each membrane.
(D) Western blot detection of RhoA in fractions obtained as a result of gel-chromatographic separation of cytosolic extracts from WJMSC1 cells at passages 9, 15, 28.
Electrophoretic separation was carried out in 12\% acrilamide gels, then proteins were transferred to PVDF membranes and stained with polyclonal antibodies against synthetic peptide corresponding to amino acids 177-189 located near the C-terminus of human RhoA.
Fraction number indicated obove each membrane.
Passage number indicated on the right from each membrane.
