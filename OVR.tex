...
\begin{table}[hbt!]
  \label{tab:pca-M9}
  \caption{PCA analisys of myosin-9/F-actin colocalization data loadings for 2 factors}
\centering
...
\begin{figure}[hbt!]
  ...
  \caption{Correlation matrix of correlation coefficients calculated for correspondent colocalization.}
  \centering
\end{figure}

\begin{figure}[hbt!]
  \includegraphics[width=1\linewidth]{supp2.jpg}
  \caption{(A) Variables factor map (PCA) (C) Scree plot (D) Correlation plot (E) Pairwise comparison post hoc tests.}
  \centering
\end{figure}
