...
\abbrevs{DMEM, Dulbecco's modified Eagle's medium; DOX, sodium deoxycholate; FBS, fetus bovine serum; FPLC, fast performance liquid chromatography; HRP, Horseradish Peroxidase; MSCs, mesenchymal stem cells; RCF, relative centrifugal force; PCA, principal component analisys; MSCWJ-1, human umbilical cord MSCs cell line; MW, molecular weight; bTau, $\tau$-Kendall rank correlation coefficient; Rs, Spearman's R correlation coefficient; tM, Manders correlation coefficient; Rval, Pearson correlation coefficient; SD, standard deviation}
...
\fundinginfo{This article was published with the financial support from the Institute of Cytology RAS Director's Fund}
...
The immunofluorescence confocal images of MSCWJ- 1 stained for $\alpha$-actinin-4 at passages 9, 15, 36 shown in Fig. 2.
...
Speed and path length decreased with increase in passage number.
The straightness of the trajectory increases with the passage from passage 15 to 36.
...
Cytosolic extracts from MSCWJ-1 were obtained in such a way that after centrifugation, nuclei, cell organelles, vesicles, and the cytoskeleton concentrated in the sediment.
Supernatants were applied to a column calibrated using a set of proteins with known molecular weights.
The range of fractions collection was chosen by us in such a way as to capture an area from 10 to 2000 kDa, this range was divided into 14 equal fractions (Fig. 6B).
Comparison of elution profiles recorded during gel chromatographic separation of cell extracts at passages 9, 15, 36 reveales general similarity (Fig. 6A).

To investigate myosin-9 distribution among the fractions, membrains were stained with polyclonal antibodies against synthetic peptide corresponding to amino acids 1949-1960 of human nonmuscle myosin IIA and HRP-conjugated secondary anti-rabbit antibodies.
Myosin-9 was detected at passage 9 in high molecular weight fractions 3--4 (approximately 1000---1500 kDa), and to a lesser extent in fraction 7 (correspondent to the size of the dimer 450 kDa), and in fraction 9, which is approximately equal to the size of the monomer 225 kDa.
At passage 15, myosin-9 was detected mainly in fractions 3--4, with additional band obove the main isoform.
At passage 28, myosin-9 was detected at a high level in fractions 3---4, at a moderate level in fractions 5--9 (Fig. 6C).

To investigate $\alpha$-actintin-4 distribution among the fractions, membrains were stained with polyclonal antibodies against human $\alpha$-actintin-4 and HRP-conjugated secondary anti-rabbit antibodies.
$\alpha$-Actintin-4 was detectet as one peak eluted in fraction 6 (approximately 700 kDa) at all investigated passages (Fig. 6C).

To investigate $\beta$-actin distribution among the fractions, membrains were stained with mouse monoclonal anti-$\beta$-actin antibodies and HRP-conjugated secondary anti-mouse antibodies.
$\beta$-Actin is detected mainly in the 10---11 fractions at passage 9, correspondent to 45 kDa actin monomer.
But at 15 and 28 passages $\beta$-actin also revealed in fractions 6---7 (approximately 500--100 kDa).

To investigate RhoA distribution among the fractions, membrains were stained with polyclonal antibodies against synthetic peptide corresponding to amino acids 177-189 located near the C-terminus of human RhoA and and HRP-conjugated secondary anti-rabbit antibodies.
At passage 9, RhoA was detected in fractions 6--10 as 100 kDa band, in fractions 6--7 as bands with approximately 50, 70, 80 kDa.
At passage 15, RhoA was detected in fractions 6--10 as 100 kDa band, in fractions 6--8 as three band pattern (approximately 70, 80, 100 kDa).
At passage 28, RhoA was detected in fraction 6 as two bands with MW approximately 70, 80 kDa.
One band with a molecular weight of 21 kD was detected in passage 15 in fraction 3.
...
Since mammalian nonmuscle myosin II isoforms is a kew proteins in regulation cell motility (\cite{shutova2017self}, \cite{shutova2018mammalian}), we investigated its distribution at various passages.
...
Since the change in the nature of cell movement is due to changes in adhesion and under control of Rho (\cite{huveneers2009adhesion}), we decided to reveal RhoA distribution in MSCWJ1 cells.
...
From gel filtration studies we see, that at all investigated passages RhoA elutes in the form of complexes similar in electrophoretic mobility, but passage 28-derived RhoA complex lacks the 100 kDa band.
On the other hand, RhoA is detected as a 21 kDa monomer in fracion 3 (approximately 1000 kDa) eluted after passsage 15 extract loading.
These results indicate structural rearrangements occurring in RhoA cytoplasmic protein complexes, regulating its nuclear cytoplasmic distribution, and require further research in this direction
...
We conducted PCA and logistic regression in order to identify the colocalization coefficient most suitable for our purposes.
The results shown in Supplementary Table S2 and Figure S1.
Shortly, bTau and Rs coefficients shows very high correlation, tM1 and Rval coefficients shows moderate correlation.
Logistic regression shows that bTau is the best predictor for MSCWJ-1 passage number, Kruskal-Wallis rank sum test results suggest that bTau reflects changes in colocalization so well (Tables S3---S6 in Supplement).
...
In further analysis, the values of the bTau shown were interpreted in accordance with the Cheddock scale (see Table S1 in Supplementary).
...
Rabbit polyclonal antibodies produced against the N-terminal peptide of myosin-9, mouse monoclonal anti-$\beta$-actin antibodies (clone AC-15) were used as the first antibodies.
Rabbit antibodies to mouse antigens and goat antibodies to rabbit antigens conjugated with HRP were used as second antibodies (Sigma-Aldrich, USA, Missouri).
...
(A) Characteristic images from trajectory analysis workflow.
...
X axis indicates retention time, in minutes, Y axis indicates optical absorbance at 280 nm, in arbitrary units (a.u.).
(C) Western blot detection of myosin-9, $\alpha$-actinin-4 and $\beta$-actin in fractions obtained as a result of gel-chromatographic separation of cytoplasmic extracts from MSCWJ1 cells at passages 9, 15, 28.
...
(D) Western blot detection of RhoA in fractions obtained as a result of gel-chromatographic separation of cytoplasmic extracts from MSCWJ1 cells at passages 9, 15, 28.
