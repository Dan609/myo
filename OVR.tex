...
(C) Scree plot (D) Correlation plot (E) Pairwise comparison post hoc tests.

(C, D) Correlation matrix of correlation coefficients calculated for correspondent colocalization.

(B) Variables factor map (PCA).
