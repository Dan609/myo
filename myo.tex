...
\author[1\authfn{1}]{Danila Bobkov PhD}
\author[2\authfn{1}]{Anastasia Polyanskaya BD}
\author[1\authfn{2}]{Anastasia Musorina PhD}
\author[1\authfn{2}]{Ekaterina Lomert PhD}
\author[1\authfn{2}]{Sergey Shabelnikov PhD}
\author[1\authfn{2}]{Galina Poljanskaya PhD}
