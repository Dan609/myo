...
\section*{Supporting Information listing, if appropriate}
...
Figure 1. (A) Staining of F-actin (red) and myosin-9 (green) in cells at different passages (E) The proportion of cells with pronounced activity of $\beta$-galactosidase ($\beta$-gal) in the process of cultivating the MSCWJ-1 line
...
Supplementary figure. Matrix of plots with a data set containing myosin-9/F-actin colocalization coefficients. Colocalization coefficients correlation analisys.
