...
Cells were cultured under conditions of 5\% CO2 at 37$\degree$ C and humidity of 90\%.
...
To visualize the actin cytoskeleton, cells were stained with rhodamine phalloidin for 20 min at room temperature and stained with DAPI with final concentration 1.5 $\mu$g m$L^{−1}$. Preparations were made on ProLong Gold antifade reagent containing.
...
The values of the correlation coefficient bTau were interpreted in accordance with the Cheddock scale (see table \ref{cheddock} in supplement for details).
...
In order to determine the degree of aging characteristic for various passages, we analyzed the $\beta$-galactosidase activity in MSCWJ-1 cell line.
