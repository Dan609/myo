...
\abbrevs{MSCs, mesenchymal stem cells;  $\tau$-Kendall rank correlation coefficient; Rs, Spearman's R correlation coefficient; tM, Manders correlation coefficient; Rval, Pearson correlation coefficient; PCA, principal component analisys}
...
\begin{table}[hb!]
  \caption{Cheddock scale for Kendall correlation coefficient qualitative estimation as described in \cite{hinkle2003applied} and \cite{mukaka2012guide}}
\centering
\begin{tabular}{|c|c|}
...
\begin{table}[hbt!]
  \caption{Maximum-likelihood factor analysis on the myosin-9/F-actin colocalization data matrix for 2 factors (\cite{lawley1962factor}). Cells were grown on glasses, fixed and permeabilised at passages 7, 9, 12, 15, 18, 21, 25, 27, 28, 35, 36. F-actin and myosin-9 were stained with specific antibodies, confocal images were passed to ImageJ. Cells were manually selected on merged images and Coloc2 plugin were used to calculate colocalization coefficients ((\cite{rueden2017imagej2})). Statistical analysis was performed in R using factanal function (\cite{team2014r}).}
\centering
...
\begin{table}[hbt!]
  \caption{Kruskal-Wallis rank sum test results for myosin-9/F-actin colocalization coefficients. Cells were grown on glasses, fixed and permeabilised at passages 7, 9, 12, 15, 18, 21, 25, 27, 28, 35, 36. F-actin and myosin-9 were stained with specific antibodies, confocal images were passed to ImageJ. Cells were manually selected on merged images and Coloc2 plugin were used to calculate colocalization coefficients ((\cite{rueden2017imagej2})). Statistical analysis was performed in R (\cite{team2014r}).}
\centering
\begin{tabular}{l|ccc}
    \hline
...
\begin{table}[hbt!]
  \caption{Logistic regression with myosin-9/F-actin colocalization coefficients as predictors and passage numger as fitted values. Cells were grown on glasses, fixed and permeabilised at passages 7, 9, 12, 15, 18, 21, 25, 27, 28, 35, 36. F-actin and myosin-9 were stained with specific antibodies, confocal images were passed to ImageJ. Cells were manually selected on merged images and Coloc2 plugin were used to calculate colocalization coefficients ((\cite{rueden2017imagej2})). Statistical analysis was performed in R (\cite{team2014r}).}
\centering
...
\begin{table}[hbt!]
  \caption{Logistic regression with $\alpha$-actinin-4/Hoechst33342 colocalization coefficients as predictors and passage numbers as fitted values. Cells were grown on glasses, fixed and permeabilised at passages 9, 15, 28, 36. $\alpha$-actinin-4 was stained with specific antibodies, confocal images were passed to ImageJ. Cells were manually selected on merged images and Coloc2 plugin were used to calculate colocalization coefficients ((\cite{rueden2017imagej2})). Statistical analysis was performed in R (\cite{team2014r}).}
\centering
\begin{tabular}{rrrrr}
  \hline
...
\begin{table}[hbt!]
  \caption{Superose 6 column calibration protein set. FPLC system equipped with Superose 6 column was used.
