...
However, Pearsons correlation coeff.
It can be pretty noisy, it can be noisy, it can be lost, it can be lost.
... for Replicate Based Noise Corrected Correlation and a patent has been applied for pairs corrupted by severe noise.. (\cite{adler2008replicate}; \cite{bergholm2010analysis})
