...
\abbrevs{MSCs, mesenchymal stem cells; DEF, doesn't ever fret; GHI, goes home immediately.}
...
\runningauthor{Bobkov et al. Motility changes in ageing MSCs}
...
A decrease in the colocalization of myosin-9 and alpha-actinin-4 F-actin was found at 15 passages, then the colocalization gradually increased to passage 36.
Using the automated system of intravital confocal microscopy CQ1, the characteristics of cell motility in various passages were studied.
It was found that during replicative aging in MSCWJ-1 cells, a decline in cell speed and path lenth occurs.


% Please include a maximum of seven keywords
\keywords{mesenchymal stem cells, \emph{cellular senescense}, actin, myosin-9, $\alpha$-actinin-4, RhoA, cell motility}
\end{abstract}
...
From the results of table 1, it follows that in the MSCWJ-1 line, the prominent process of replicative senescence begins after 10 passages.
...
Fig. 1 shows cells stained with rhodamine-phalloidin and antibodies against myosin-9.
...
Figure 2. F-actin and Myosin-9 Colocalization in MSCWJ-1 (A) bTau coefficient changes in course of replicative senescence (B) Variables factor map (PCA) (C) Scree plot (D) Correlation plot (E) Pairwise comparison post hoc tests.


Figure 3. Different passages staining of F-actin (red) and alpha-actintin-4 (green).


Figure 4. (A) Colocalization of F-actin and Hoechst 33224 at different passages (B) Colocalization of F-actin and alpha-actintin-4 at different passages (C, D) Correlation matrix of correlation coefficients calculated for correspondent colocalization.


Figure 5. RhoA in the nucleus, along the stress In the perinuclear region, diffusely in the cytoplasm.


Figure 6. Confocal view of RhoA in the nucleus.


Figure 7. Cell movement analisys.


Figure 8. Gel chromatographic separation of cytoplasmic extracts from MSCWJ-1 cells at different stages of replicative senescence. Separation of calibration proteins (A) and comparison of elution profiles are presented. Electrophoretic separation of proteins from fractions obtained as a result of gel-chromatographic separation of cytoplasmic extracts from WJ1 cells in various stages of replicative senescence.
...
\begin{figure}[hbt!]
\centering
\includegraphics[width=0.9\linewidth]{figures.jpg}
\caption{Fig. 1}
\end{figure}
